...
public class LivrariaOnline {
    ...
    public static void main(String[] args) {
        ...
        livrariaOnline.adicionarLivro("https://amzn.to/3L1FFI6", new Livro("Caixa de Pássaros", "Josh Malerman", 19.99d));
        ...
        System.out.println("- Lista de livros por preco:");
        ...
        System.out.println("- Lista de livro sem o removido: ");
